...
public class Jhipstersa2App {

    private static final Logger log = LoggerFactory.getLogger(Jhipstersa2App.class);

    private final Environment env;

    public Jhipstersa2App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipstersa2.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Jhipstersa2App.class);
